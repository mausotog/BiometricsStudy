...
hours~\cite{gonzalez2004constant,mark2008cost,czerwinski04diary}. These 
challenges make it difficult for a knowledge worker to stay focused and
impact interaction with their digital environment, the quality of work performed and productivity. For instance, the 
continuous disruptions that knowledge workers face in office work environments 
can lead to a higher error rate and a lower 
performance~\cite{bailey2001effects,mark2008cost}. In some cases,
the consequences are even more severe; e.g., in control room
settings, the consequences of an erroneous intraction can lead to accidents valued in millions of dollars in losses. 
...
Less immediate, but just as insidious, stress at the workplace is a growing 
concern and one of the most common work-related health problems. It leads to 
...
Being able to continuously measure human aspects --- such as focus, awakeness, 
and stress --- in the workplace bears huge potential for better supporting 
knowledge workers combatting workplace challenges, and improving productivity 
and well-being. Such measures could be used to provide better interaction with 
their environment, such as management 
of disruptions~\cite{iqbal2005effectiveness,zuger2017reducing}, to 
automatically adjust lighting and temperature to reduce sleepiness, or to continuously monitor stress levels to trigger pro-active 
interventions and reduce health problems. 

Fortunately, with recent advances in sensing technologies there is increasing 
hope that we can accurately and automatically measure such human aspects. A 
...
The objective of our research is to develop continuous (and automatic) 
measures of focus, awakeness, and stress in the workplace. These measures are 
targeted towards improving knowledge workers' productivity and 
well-being in the future by customizing interaction with their environment; e.g., by automatically protecting the workers
from audible interruptions during a high focus period by showering them 
with white noise or by recommending stress-reducing interventions during an 
