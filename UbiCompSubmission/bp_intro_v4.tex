...
techniques, such as measuring cortisol as a stress biomarker~\cite{piazza10} which are best suited
for laboratory environments.  Further research has shown the benefit of using
...
environment of knowledge workers to analyze an extensive collection of biometric signals with experience samples examining real-time prediction of stress in the workplace~\cite{sano2013stress,healey2005detecting,wijsman2011towards,zuger2015interruptibility,goyal2017intelligent,Parnin2011,Nakagawa2014,Radevski2015}.
Previous studies are predominantly controlled lab studies which used only a subset of the relevant biometric signals we captured, have been much more limited in duration, or are not focused on the workplace. 
...
development group within a single large corporation, wore a novel, state-of-the-art
