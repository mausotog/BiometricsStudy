...
Previous studies are predominantly controlled lab studies which used only a subset of the relevant biometric signals we captured, have been much more limited in duration, or are not focused on a real-world environment0. 
