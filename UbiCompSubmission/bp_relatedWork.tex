...
using biometerics to predict them. We consider
...
Similarly, we considered adding additional metrics such as Depression, Anxiety and Stress Scale (DASS) and Perceived Stress Scale (PSS)~\cite{Ferdous15} but opted for the ones presented in the paper after several discussions with experts in the area, and after piloting surveys to maxime participant compliance.
