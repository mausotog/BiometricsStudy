...
of the human body, such as blood pressure (e.g.,~\cite{katoka00}).
...
In this paper, we build on this ability to 
investigate stress in the wild, investigating two questions: RQ1) how do knowledge
workers at work experience stress over time, and RQ2) can we predict
whether an knowledge worker is experiencing stress in the moment based
...
collecting biometric and computer interaction data as well as
...
challenges that contribute to stress levels can make it hard for
knowledge workers to stay focused and because the level of focus
can affect
