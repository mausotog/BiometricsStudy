...
\section{Field Study}
We conducted an eight-week field study with 14 participants using experience sampling and biometric sensors to investigate how knowledge workers experience stress\rev{, focus and awakeness} over time and the feasibility of predicting stress, focus, and awakeness \rev{using} biometric signals. 
