...
\begin{figure}
  \centering
      \includegraphics[width=0.7\textwidth]{dailystress_s1.pdf}
      \includegraphics[width=0.7\textwidth]{dailystress_s3.pdf}
...
\begin{itemize}
\item The participant not wearing the Everion in the hour before beginning the survey
...
\begin{table*}[h]
  ...
  \caption{Results of predictions using the individual models. The distribution columns show a bar chart of the response distribution (negative/positive) for each of the three variables. The baseline row represents the averaged results of our baseline classifier. The general row shows the averaged results of our models trained on all participants.}\label{tab:accuracy}%\todo{revise caption}}
  \vspace*{-4mm}
\end{table*}
...
62\% in recall, and 7\% in accuracy) than for stress or focus. In addition,
