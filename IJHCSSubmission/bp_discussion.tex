...
prevent or de-escalate potentially dangerous situations in the
workplace \rev{(e.g., confrontation between co-workers)}. Building an 
...
As in modern cars, temperature and lighting could be
...
The two primary reasons for this intervention \rev{were} to keep participants motivated to continue the self-reports over the long study period, and to offer a technique that might help reduce stress.
...
is a common and effective practice~\cite{branco2016survey}. Alternative techniques such as SMOTE~\cite{chawla2002smote} exist and can perform better than those we employed, however they are impractical considering the limited amount of data we have to work with. 

Oversampling the dataset as we did may also lead to an increased risk of model overfitting. However, we believe the benefits of rebalancing the dataset outweigh this possible downside. In light of the imbalance
