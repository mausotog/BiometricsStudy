...
created classifiers and analyzed their ability to predict stress, focus, and awakeness levels. Considering all of these three human aspects helps us to consider whether one aspect might be easier to detect than another. If one aspect is easier to predict, it might serve
...
\begin{itemize}
	\item A qualitative examination of how knowledge worker stress and awakeness presents and fluctuates in the wild based on an eight-week field study with 14 office workers.
