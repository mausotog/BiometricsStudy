...
autonomic nervous system (ANS) activity by analyzing \rev{certain biometric (\textit{aka.} psycho-physiological) signals}
...
\rev{Our work builds on this ability to non-invasively monitor stress by performing an eight-week study in the workplace with 14 knowledge workers examining stress as well as two related human aspects: focus and awakeness (i.e., wakefulness). We collected data on these two additional aspects because stress and the challenges that contribute to stress levels can also affect sleep. A lack of sleep can affect
...
\rev{In this paper, we investigate two research questions. First, what is the experience of knowledge
workers at work with respect to stress and awakeness over longer periods of time time? Second, can we use
biometric data to predict whether a knowledge worker is experiencing stress, is focused and is awake at 
a given moment in time?} A better understanding of how knowledge workers experience stress, focus
...
created classifiers and analyzed their ability to predict stress, focus, and awakeness levels. Considering all of these three human aspects helps us to consider whether one aspect might be easier to detect than another. If one aspect is easier to \rev{predict}, it might serve
...
\begin{itemize}
	\item A qualitative examination of how knowledge worker stress \rev{and awakeness} presents and fluctuates in the wild based on an eight-week field study with 14 office workers.
