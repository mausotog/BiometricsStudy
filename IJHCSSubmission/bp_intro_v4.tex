...
%\tf{a lack of focus} \gm{suggest removing the phrase 'a lack of focus' - better where it comes in later}, 
...
%\tf{In this paper, we investigate two research questions: RQ1) how do knowledge workers at work experience stress and also awakeness \gm{can we remove 'also awakeness' - why not focus - it was asked in the survey?}  over time, and RQ2) can we use biometric data to predict whether a knowledge worker is experiencing stress as well was whether the worker is focused and/or awake.
%A better understanding of how stress is experienced (RQ1) can help inform the design of workplaces to manage
%and alleviate stress and awakeness. An ability to predict stress, focus and awakeness in the moment (RQ2) can enable the development of digital tools to support the knowledge worker in their work, for instance, by better managing disruptions, automatically adjusting lighting to reduce sleepiness, or by avoiding stress.}

In this paper, we investigate two research questions. \rev{Our first question examines how knowledge workers experience stress and awakeness in their workplace over a long period of time. Our second question explores the possibility of using biometric data to predict whether a knowledge worker is experiencing stress, is focused, and is 
awake at a given moment in time.} A better understanding of how knowledge workers experience stress, focus
...
% undesired consequences on work~\cite{connor02}. \tfC{We could also say that stress can lead to less sleep and therefore an increased lack of awakenes, which in turn can also result in... (this way we can frame awakeness and focus as two factors that are affected and almost 'derived' by stress)}

The participants in
our study perform various job functions for a research and
development group within a single large corporation. \rev{For this study, they wore a novel, state-of-the-art
biometric armband comprised of precise sensors\footnote{Biovotion Everion~\cite{everion}} which captured heart-,
respiration- and skin-related measures with low invasiveness}. This modality was chosen to
ease longitudinal deployment in the field. \rev{We then used machine learning to create classifiers and analyze their ability to predict stress, focus and awakeness levels based on 
the biometric signs gathered by the sensors}. Considering all of these three human aspects helps us to 
...
%\tfC{last sentence is somehow odd} 
...
minimally invasive \rev{device} can be used to predict stress and its
related aspects accurately, with the abstract concept of focus
(predictably) being the hardest to detect. Our results further \rev{determine}
...
\begin{itemize}
	\item A qualitative examination of how knowledge worker stress and awakeness \rev{behaves} and fluctuates in the wild based on an eight-week field study with 14 office workers.
