...
\section{Observed Trends in Stress Levels}
\label{stressTrends}
...
\vspace{-4mm}
Common among all participants was a trend to select one stress rating
...
\begin{figure}
  \centering
      \includegraphics[width=0.4\textwidth]{dailystress_s1.png}
      \includegraphics[width=0.4\textwidth]{dailystress_s3.png}
  \caption{The day-to-day stress levels reported by two participants. Y-axis represents values on the 5-point Likert scale. The x-axis represents the day of the study.}
...
\subsection{Extreme Changes are Rare}
...
\begin{figure}
  ...
  \caption{Biometric data available per each participant. Green sections represent survey responses with biometric
...
\begin{table}
  ...
  \caption{Distribution of the responses of each participant. Each bar in the histograms represent one of the 5 values on the 5-point Likert scale, the far left side of the histograms are 1/Not at all, and the far right sides are 5/Extremely}
