...
To gain a better understanding of our participants day-to-day work activities, we installed an open source computer interaction monitor (reference omitted for doubleblind.) to track the participant's active window, as well as keyboard and mouse activity. 4 of our participants opted out of this part of the study for privacy reasons (S6, S10, S12, and S13) so for this reason we did not include this data in our predictive model. However we did look at the computer interaction data as a potential part of an explanatory model.
